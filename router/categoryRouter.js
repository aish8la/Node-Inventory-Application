...
categoryRouter.post('/new', categoryValidators.addValidation, validate, auth, categoryController.newCategoryPost);
categoryRouter.get('/:categoryId/edit', categoryValidators.paramValidation, validate, categoryController.editCategoryGet);
categoryRouter.post('/:categoryId/edit', categoryValidators.editValidation, validate, auth, categoryController.editCategoryPost);
categoryRouter.get('/:categoryId/delete', categoryValidators.paramValidation, validate, categoryController.deleteCategoryGet);
categoryRouter.post('/:categoryId/delete', categoryValidators.paramValidation, validate, auth, categoryController.deleteCategoryPost);
